...
from app.schemas.management_responses import PaginatedResponse, TenantResponse
...
async def create_tenant(
    ...
    try:
        return TenantResponse.model_validate(await service.create_tenant(body))
...
async def list_tenants(
    ...
    status_filter: Annotated[TenantLifecycleStatus | None, Query()] = None,
    tier_filter: Annotated[TenantSubscriptionTier | None, Query()] = None,
...
async def get_tenant(
    ...
    try:
        return TenantResponse.model_validate(await service.get_tenant(tenant_id, current_user))
    except LLMServiceError as exc:
        translate_management_error(exc)
